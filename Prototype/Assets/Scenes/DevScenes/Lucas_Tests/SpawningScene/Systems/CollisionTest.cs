using Scenes.DevScenes.Lucas_Tests.SpawningScene;
using Unity.Burst;
...
struct TriggerJob : ICollisionEventsJob
{
    ...
    public void Execute(CollisionEvent collisionEvent)
    {
        ...
        if (allBoulders.HasComponent(entityA) && allMasses.HasComponent(entityB))
        {
            ...
            inertiaComponent.InverseInertia = new float3(massComponent.BaselineInertiaX, massComponent.BaselineInertiaY, massComponent.BaselineInertiaZ);
